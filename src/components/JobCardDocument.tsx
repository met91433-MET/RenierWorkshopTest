...
export default function JobCardDocument({
  ...
  if (page === 'page2') {
    return (
      <div className={`bg-white ${borderClass} border-black p-5 w-full h-full text-black font-sans relative aspect-[210/297] flex flex-col justify-between shadow-sm`}>
  ...
  // Page 1 Render (Doubled Text Sizes Across Entire Page)
  return (
    <div className={`bg-white ${borderClass} border-black p-5 w-full h-full text-black font-sans relative aspect-[210/297] flex flex-col justify-between shadow-sm`}>
      <div className="flex-1 flex flex-col min-h-0 justify-between gap-2.5">
          ...
          <div className={`${borderClass} border-black p-4 flex justify-between items-center bg-white`}>
            ...
            <div className={`flex items-center gap-3.5 ${format.logoAlignment === 'center' ? 'flex-1 justify-center' : ''}`}>
              ...
              <div className="text-left leading-tight">
                <div className="text-2xl font-black tracking-tight text-slate-900 font-display">{format.companyName}</div>
          ...
          <div className={`grid grid-cols-12 border-x-2 border-b-2 border-black bg-white`}>
            ...
            <div className="col-span-7 flex flex-col justify-between border-r-2 border-black">
              <div className="p-3 flex-1 flex flex-col justify-center items-center bg-slate-50/30 min-h-[65px]">
                ...
                <span className="text-2xl font-black tracking-wider font-display text-center leading-snug uppercase" style={{ color: customerTextColor }}>
        ...
        {format.sections.find(s => s.id === 'work_instructions')?.enabled !== false && (
          <div className={`border-x-2 border-b-2 border-black p-4 bg-white flex-1 flex flex-col justify-between min-h-[220px] relative`}>
            <div>
                  ...
                  return (
                    <div className="space-y-2">
                      ...
                      {details.instructions && (
                        <div className="mt-3 pt-3 border-t border-slate-300 text-slate-900 whitespace-pre-line leading-relaxed font-semibold text-[15px]">
